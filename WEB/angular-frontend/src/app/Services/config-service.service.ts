...
export class ConfigServiceService {
  ...
  _addReactionComment_url:string;
  constructor() {
...
this._addComment_url = this._api_url + "/comment/addReactionComment";
    this._addReactionComment_url = this._api_url + "/comment/addReactionToComment";
